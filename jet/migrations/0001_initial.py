    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "settings",
                    models.TextField(default=b"", verbose_name="settings", blank=True),
                ),
                (
                    "children",
                    models.TextField(default=b"", verbose_name="children", blank=True),
                ),
                (
                    "collapsed",
                    models.BooleanField(default=False, verbose_name="collapsed"),
                ),
            ],
            options={
