...
class DefaultIndexDashboard(Dashboard):
    ...
    def init_with_context(self, context):
        ...
        self.children.append(
            modules.AppList(_("Administration"), models=("auth.*",), column=0, order=0)
        )

        # append an app list module for "Applications"
        self.children.append(
            modules.AppList(_("Applications"), exclude=("auth.*",), column=0, order=1)
        )
        ...
        self.children.append(
            modules.RecentActions(_("Recent Actions"), 10, column=1, order=0)
        )
