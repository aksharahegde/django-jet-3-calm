    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "settings",
                    models.TextField(verbose_name="settings", blank=True, default=""),
                ),
                (
                    "children",
                    models.TextField(verbose_name="children", blank=True, default=""),
                ),
                (
                    "collapsed",
                    models.BooleanField(verbose_name="collapsed", default=False),
                ),
            ],
            options={
