...
gulp.task('styles', function() {
    return gulp.src('./jet/static/jet/css/**/*.scss', { allowEmpty: true })
...
gulp.task('vendor-styles-images', function() {
    return gulp.src('./node_modules/jquery-ui/themes/base/images/*', { allowEmpty: true })
...
gulp.task('vendor-translations-jquery-ui', function() {
    return gulp.src(['./node_modules/jquery-ui/ui/i18n/*.js'], { allowEmpty: true })
...
gulp.task('vendor-translations-timepicker', function() {
    return gulp.src(['./node_modules/jquery-ui-timepicker-addon/dist/i18n/*.js'], { allowEmpty: true })
...
gulp.task('vendor-translations-select2', function() {
    return gulp.src(['./node_modules/select2/dist/js/i18n/*.js'], { allowEmpty: true })
